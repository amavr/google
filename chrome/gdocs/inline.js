...
function doNewDoc(){
	$('#new_doc_container').toggle();
	return false;
}

function doRefreshDoc(){
	gdocs.refreshDocs();return false;
}
...
$(function(){
	$("#a-new").bind('click', doNewDoc);
	$("#a-refresh").bind('click', doRefreshDoc);
	$("#btn-new").bind('click', btnClickNew);
});
